...
import { PAGE_GRADIENT, PAGE_BG, CARD_BG_PATTERN, TEXT_MUTED, ACCENT, ERROR, H3 } from '../utils/theme';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: PAGE_GRADIENT }}>
      <div className="w-full max-w-lg relative z-10 fade-in">
        ...
        <div className="p-8 rounded-lg" style={{ background: CARD_BG_PATTERN, boxShadow: '0 6px 12px 0 rgba(0, 0, 0, 0.25)' }}>
          {error && (
